...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fitbm%2Fchatbot-ui)
...
```
docker run -e OPENAI_API_KEY=xxxxxxxx -p 3000:3000 ghcr.io/itbm/chatbot-ui:latest
```
...
```bash
git clone https://github.com/itbm/chatbot-ui.git
```
